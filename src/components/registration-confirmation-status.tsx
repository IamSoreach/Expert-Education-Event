      ...
      <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          <Link
            ...
            className="palette-cycle-button inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-semibold text-white shadow-[0_12px_26px_-16px_rgba(6,50,99,0.7)]"
          >
            Submit Another
          </Link>
          <Link
